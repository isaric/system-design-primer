...
**BASE** is often used to describe the properties of NoSQL databases.  In comparison with ACID(#relational-database-management-system-rdbms), BASE chooses availability over consistency.
